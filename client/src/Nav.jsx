    ...
    <div>
      <nav className="navbar navbar-expand-lg bg-transparent fixed-top">
        <div className="container-fluid">
          ...
          <div
            className="offcanvas w-50 offcanvas-start bg-teritary"
            tabIndex="-1"
          ...
          >
            ...
            <div className="offcanvas-body">
              <ul className="navbar-nav justify-content-lg-end flex-grow-1 pe-lg-3">
